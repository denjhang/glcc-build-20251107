...
#line 40 "x86linux.c"
/*
generated at Fri Nov 21 12:25:28 2025
by $Id$
*/
...
static void _closure_reg(NODEPTR_TYPE a, int c) {
	...
	int d;
	d = c + 2;
	if (d + 0 < p->cost[_addrj_NT]) {
		p->cost[_addrj_NT] = d + 0;
		p->rule._addrj = 2;
	}
	d = c + 0;
	if (d + 0 < p->cost[_rc5_NT]) {
		p->cost[_rc5_NT] = d + 0;
		p->rule._rc5 = 2;
	}
	d = c + 0;
	if (d + 0 < p->cost[_mr2_NT]) {
		p->cost[_mr2_NT] = d + 0;
		p->rule._mr2 = 1;
		_closure_mr2(a, d + 0);
	}
	d = c + 0;
	if (d + 0 < p->cost[_mr1_NT]) {
		p->cost[_mr1_NT] = d + 0;
		p->rule._mr1 = 1;
		_closure_mr1(a, d + 0);
	}
	d = c + 0;
	if (d + 0 < p->cost[_mr_NT]) {
		p->cost[_mr_NT] = d + 0;
		p->rule._mr = 1;
		_closure_mr(a, d + 0);
	}
	d = c + 0;
	if (d + 0 < p->cost[_rc_NT]) {
		p->cost[_rc_NT] = d + 0;
		p->rule._rc = 1;
		_closure_rc(a, d + 0);
	}
	d = c + 0;
	if (d + 0 < p->cost[_index_NT]) {
		p->cost[_index_NT] = d + 0;
		p->rule._index = 1;
		_closure_index(a, d + 0);
	}
	d = c + 0;
	if (d + 0 < p->cost[_base_NT]) {
		p->cost[_base_NT] = d + 0;
		p->rule._base = 1;
		_closure_base(a, d + 0);
	}
...
static void _closure_freg(NODEPTR_TYPE a, int c) {
	...
	int d;
	d = c + 0;
	if (d + 0 < p->cost[_cmpf_NT]) {
		p->cost[_cmpf_NT] = d + 0;
		p->rule._cmpf = 4;
	}
	d = c + 0;
	if (d + 0 < p->cost[_flt2_NT]) {
		p->cost[_flt2_NT] = d + 0;
		p->rule._flt2 = 2;
	}
	d = c + 0;
	if (d + 0 < p->cost[_flt_NT]) {
		p->cost[_flt_NT] = d + 0;
		p->rule._flt = 2;
	}
	d = c + 0;
